...
struct ncclNvlsSharedRes {
  ...
  size_t buffUCSize;
  size_t buffMCSize;
  hipMemGenericAllocationHandle_t mcBuffHandle; // Multicast handle for NVLS buffer
  hipMemGenericAllocationHandle_t mcCreditHandle; // Multicast handle for NVLS credit buffer
  char* mcBuff; // Multicast NVLS buffer address
  char* mcCredit; // Multicast NVLS credit address
  hipMemGenericAllocationHandle_t ucBuffHandle; // Unicast Handle for NVLS buffer
  hipMemGenericAllocationHandle_t ucCreditHandle; // Unicast Handle for NVLS credit buffer
...
ncclResult_t ncclNvlsDeregBuffer(struct ncclComm* comm, hipMemGenericAllocationHandle_t *mcHandler, hipDeviceptr_t ptr, int dev, size_t ucsize, size_t mcsize);
...
ncclResult_t ncclIpcSymmetricMap(struct ncclComm* comm, size_t offset, size_t size, hipMemGenericAllocationHandle_t memHandle, void** symPtr);
